...
function CardXl({ venueId }) {
  ...
  if (isLoading) return (
    <div className='max-w-[500] flex items-center justify-center gap-2 my-80'>
      <p className='text-center font-imfell italic text-crimson text-xl'>Loading venue display</p>
  ...
  if (!venue) return (
    <div className='max-w-[500] flex items-center justify-center gap-2 my-80'>
      <p className='text-center font-imfell italic text-crimson text-xl'>Venue not found. Please refresh the page</p>
      <span className='text-center font-imfell italic text-crimson text-xl dot dot-1'>.</span>
      <span className='text-center font-imfell italic text-crimson text-xl dot dot-2'>.</span>
      <span className='text-center font-imfell italic text-crimson text-xl dot dot-3'>.</span>
    </div>
    ...
    <div className="flex flex-col md:flex-row bg-lamp text-light p-4 w-full max-w-[1200px] mx-auto md:h-fit transition-all ease-in-out duration-300 group">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center flex-1 border-1 border-brown-200 group-hover:border-3 transition-all duation-300 md:h-full md:px-8 px-6 py-6 gap-4">
          <p className="text-2xl italic text-brown-100  text-center font-imfell">Stay at</p>
