...
function SingleVenue() {
  ...
  const exisitingBooking = bookings.find(
    (b) => b.venue?.id === singleVenue?.id
  );
          ...
          <div className="flex flex-col gap-1 h-ful items-center justify-center lg:justify-between lg:gap-4">
            ...
            {!user?.venueManager && user !== null && !exisitingBooking && (
              <div className="flex gap-6 flex-col max-w-[500px] justify-between w-full">
                ...
                <div className="text-3xl md:text-5xl text-center font-garamond uppercase tracking-tighter text-red-800 transition-all duration-300 ease-in-out">
