...
function ProfileVenues({ venues }) {
    if (!venues || venues.length === 0) {
        return <p className="text-gray-400 uppercase font-button text-2xl pb-2 mb-5 mt-5 transition-all duration-300 ease-in-out"> You have not posted any venues yet </p>
    }
